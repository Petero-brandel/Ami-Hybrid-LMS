        ...
        <div>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div data-aos="fade-right" className="bg-white p-6 rounded-lg shadow-2xl  cursor-pointer">
                <BookOpen className="h-10 w-10 text-gray-700 mb-4" />
                <h3 className="font-bold text-gray-700 text-2xl mb-2">Hybrid Learning</h3>
              ...
              <div data-aos="fade-up" className="bg-white p-6 rounded-lg shadow-2xl  cursor-pointer">
                <Users className="h-10 w-10 text-gray-700 mb-4" />
                <h3 className="font-bold text-gray-700 text-2xl mb-2">Expert Teachers</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div data-aos="zoom-in" className="bg-white p-6 rounded-lg shadow-2xl  cursor-pointer">
                <MapPin className="h-10 w-10 text-gray-700 mb-4" />
                <h3 className="font-bold mb-2 text-gray-700 text-2xl">GPS Matching</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div data-aos="fade-up" className="bg-white p-6 rounded-lg shadow-2xl  cursor-pointer">
                ...
                <h3 className="font-bold mb-2 text-gray-700 text-2xl ">Real-time Tracking</h3>
                <p className="text-gray-600 text-sm">
